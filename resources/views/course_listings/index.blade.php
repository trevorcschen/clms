...
@section('subheader', 'Course Listing' )
@section('subheader-link', route('course_listings.index'))

@section('subheader-action', 'Lists')
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{ route('course_listings.createDetails', 3) }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
    ...
    {{--<script>--}}
        {{--$(document).ready(function() {--}}
            ...
            {{--var table = $('#subject-table').DataTable( {--}}
                ...
                {{--}, 'colvis'],--}}
                {{--ajax: "{{ route('ajax.programmes', $programme->id) }}",--}}
                {{--columns: [--}}
