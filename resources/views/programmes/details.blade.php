    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <a href="{{ route('programmes.create') }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
            ...
            <div class="m-portlet__body">
                <!--begin: Datatable -->
                <table class="table table-striped table-bordered table-hover table-checkable" id="programme-table">
                    <thead>
                    <tr>
                        <th>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#programme-table tfoot th').each(function () {
                var title = $(this).text();
            ...
            var table = $('#programme-table').DataTable( {
                ...
                ajax: "{{ route('ajaxDetails.programmes')}}",
                columns: [
